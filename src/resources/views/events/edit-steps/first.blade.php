...
<div class="required field {{ $errors->has('description') ? 'error' : '' }}">
    ...
    <textarea id="description" rows="4" name="description">{{ old('description', $event->description) }}</textarea>
...
<div class="inline fields">
    ...
    <div class="field">
        <div class="ui radio checkbox">
            <input type="radio" name="public" value="false" @if (!$event->public) checked="" @endif tabindex="0" id="privacy-private" class="hidden">
    ...
    <div class="field">
        <div class="ui radio checkbox">
            <input type="radio" name="public" value="true" @if ($event->public) checked="" @endif tabindex="0" id="privacy-public" class="hidden">
